export default {
	OpportunityQueryFields: [
		...
		"next_step", "type", "lead_source", "close_date", "probability", "arr_c", "contract_start_date_c", "contract_end_date_c",
		"mrr_c", "loss_reason_c", "loss_reason_detail_c", "closed_won_details_c", "use_case_c", "created_date", "sales_engineer_c"],
	AccountQueryFields: ["id", "name", "description", "owner_id", "website", "number_of_employees", "industry", "billing_country", "stripe_id_c", "customer_segmentation_c"],
	UserQueryFields: ["id", "username", "title", "first_name", "last_name", "email",  "time_zone_sid_key"],
